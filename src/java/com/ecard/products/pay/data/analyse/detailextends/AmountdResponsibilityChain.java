...
public class AmountdResponsibilityChain extends AbsDetailResponsibilityChain {

	public AmountdResponsibilityChain(AbsDetailResponsibilityChain next) {
		super(next);
	...
	public String processSelf(String r, int count) {
		...
		String [] rs = r.split(",");
		if(rs.length < 15 || StringUtils.isEmpty(rs[14])){

...
public class PayServiceVerifyResponsibilityChain extends ResponsibilityChain {

	public PayServiceVerifyResponsibilityChain(ResponsibilityChain next) {
		super(next);
	...
	public String processSelf(String r) {
		...
		return Constants.Verify.FNAME_PAYSERVICE_ERRMSG;
	}

    ...
    <div class="boxContent">
        ...
        <div class="normalContent">
            ...
            <div class="Content800 clearFloat">
                ...
                <div class="labelContent fl"><input type="text" id="roleName" name="roleName" class="normalInput" value="${roleInstance?.roleName}" maxlength="32"/></div>
            </div>
            <div class="Content800 clearFloat">
            ...
            <div class="Content800 clearFloat">
                ...
                <div class="labelContent fl">
                    <g:select class="selectStyle" name="roleStatus" from="${roleInstance.roleStatusMap}" value="${roleInstance?.roleStatusMap?.encodeAsHTML()}" optionKey="key" optionValue="value"/>
                </div>
            </div>
            <div class="Content800 clearFloat">

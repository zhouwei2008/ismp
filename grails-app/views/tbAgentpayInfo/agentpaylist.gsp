...
<form action="agentpaylist" method="post" name="searchform" id="searchform">
<!--内容区开始-->
<div class="InContent">
                    ...
                    <tr>
                        ...
                        <td>
                            <g:if test="${session.level3Map != null && session.level3Map['tbAgentpayInfo/verify'] != null}">
                                <a href="${request.contextPath}/${session.level3Map['tbAgentpayInfo/verify'].modelPath}/${trade.id}" class="gridBtn_normal">审核</a>
                            </g:if>
